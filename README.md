...
A small Django project that models products, categories, and tags, with a front-end page for searching and filtering the catalogue.
...
- Django admin page can be used to populate sample data.
...
4. **Load the sample data**
   ...
   The database itself isn't committed to the repo (it's a binary file and
   shouldn't be version-controlled), but a fixture with sample categories,
...
In the making of this project, I made several assumptions based on ambiguity in the instructions and what made sense for real-world use cases. These are listed below.
...
- Acting as a supplement/alternative to regular web searches for questions 
